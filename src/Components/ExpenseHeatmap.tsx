...
const ExpenseHeatmap = ({ onDateClick }: HeatmapProps) => {
  ...
  const showHover = (rect: DOMRect, date: string, count: number, amount: number, autoHide: boolean) => {
    setHoveredDay({
      date,
      count,
      amount,
                          ...
                          <div
                            ...
                            onMouseEnter={(e) => {
                              if (!isFuture && isCurrentYear) {
                                showHover(e.currentTarget.getBoundingClientRect(), dateStr, count, amount, false);
                              }
                            }}
          ...
          {hoveredDay && (
            ...
            >
              ...
              <p className="text-emerald-400 text-[11px]">
                {hoveredDay.count} transaction{hoveredDay.count !== 1 ? "s" : ""} {middleDot} {rupeeSymbol}{hoveredDay.amount.toLocaleString()}
              </p>
            </div>
          )}
        </div>
